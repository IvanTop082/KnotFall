...
- `TURING_FRONTEND_PORT` - Frontend port (default: 3001)
- `TURING_API_PORT` - Backend API port (default: 16666)
- `VITE_BREACHPATH_API_URL` - BreachPath FastAPI URL (default: http://localhost:8000)

## Architecture Overview

This is the real TuringDB React/TypeScript graph visualization application, customised for BreachPath defensive exposure analysis and using Three.js for GPU-accelerated rendering.
...
- `breachpath.ts` - BreachPath FastAPI analysis client
